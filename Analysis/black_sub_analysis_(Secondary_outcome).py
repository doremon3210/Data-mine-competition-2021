...
sub_black = pd.read_excel('../Datasets/Dataset_Sub_Black.xlsx')
...
print("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
print("Univariate Linear Regression for Secondary outcome (Sub Black)")
print("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")

# We use the Ordinary Least Square for each independent variable
for col in black_independent_var:
    X = sub_black.loc[:, col]
    Y = sub_black.loc[:, 'Death_Diabetes']
    X = sm.add_constant(X)
...
print("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
print("Multivariable Linear Regression for Secondary outcome (Sub Black)")
print("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
